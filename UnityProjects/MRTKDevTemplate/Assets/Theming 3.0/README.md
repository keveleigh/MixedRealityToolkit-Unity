...
This package works as a light data-binding system, binding theme values to components in the scene. A "theme" is made up of three parts:
...
A _theme_ is assigned a _theme definition_ and can then map all of the _theme item data_ types to concrete values.
...
_Theme data source_ is the source of truth for the current active _theme_. All mapped UI will have a reference to this source and will be informed when the current active _theme_ changes.
