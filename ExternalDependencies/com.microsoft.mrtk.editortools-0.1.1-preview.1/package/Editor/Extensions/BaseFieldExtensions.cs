...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public static class BaseFieldExtensions
	{
		...
		private const string _changedInternalsError = "Failed to setup BaseField: Unity internals have changed";
...
#if UNITY_2021_1_OR_NEWER
			var validConfigureFieldMethod = configureFieldMethod != null && configureFieldMethod.HasSignature(typeof(VisualElement), null, typeof(SerializedProperty), null);
#else
			var validConfigureFieldMethod = configureFieldMethod != null && configureFieldMethod.HasSignature(typeof(VisualElement), null, typeof(SerializedProperty));
#endif

			if (validConfigureFieldMethod)
			{
