...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidSourceError = "Invalid value source for CustomLabelAttribute on field '{0}': a string field, method, or property named '{1}' could not be found";
