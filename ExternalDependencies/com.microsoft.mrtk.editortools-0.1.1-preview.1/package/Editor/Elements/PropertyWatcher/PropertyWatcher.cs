...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	public abstract class PropertyWatcher<T> : PropertyWatcher, INotifyValueChanged<T>
	{
		...
		private const string _invalidWatcherError = "Invalid type '{0}' for PropertyWatcher: PropertyWatcher can only be used with types that have a corresponding SerializedPropertyType";
		private const string _invalidPropertyError = "Invalid property '{0}' for PropertyWatcher: the property is type '{1}' but should be type '{2}'";
