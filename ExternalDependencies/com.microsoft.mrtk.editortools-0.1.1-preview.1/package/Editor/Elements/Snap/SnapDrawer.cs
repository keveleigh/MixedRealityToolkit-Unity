...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidTypeWarning = "Invalid type for SnapAttribute on field {0}: Snap can only be applied to int, float, vector, rect, or bounds fields";
		private const string _invalidSourceError = "Invalid source for SnapAttribute on field '{0}': a field, method, or property of type '{1}' named '{2}' could not be found";
