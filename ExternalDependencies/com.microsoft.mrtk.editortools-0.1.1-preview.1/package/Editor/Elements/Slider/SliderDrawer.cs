...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidTypeWarning = "Invalid type for SliderAttribute on field {0}: Slider can only be applied to int, float, or Vector2 fields";
		private const string _invalidMinimumSourceError = "Invalid minimum source for SliderAttribute on field '{0}': a field, method, or property of type '{1}' named '{2}' could not be found";
		private const string _invalidMaximumSourceError = "Invalid maximum source for SliderAttribute on field '{0}': a field, method, or property of type '{1}' named '{2}' could not be found";
