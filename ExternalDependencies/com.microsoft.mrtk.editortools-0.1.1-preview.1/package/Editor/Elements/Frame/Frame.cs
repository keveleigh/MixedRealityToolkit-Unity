...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public class Frame : BindableElement, INotifyValueChanged<bool>
	{
		...
		public const string UssClassName = "uxtools-frame";
		...
		{
			return AddButton(icon, tooltip, ussClassName, action, false);
		}

		public IconButton InsertHeaderButton(Texture icon, string tooltip, string ussClassName, Action action)
		{
			return AddButton(icon, tooltip, ussClassName, action, true);
		}
		...
		private void BuildUi()
		{
			...
			_labelElement.AddToClassList(PropertyField.labelUssClassName);
		...
		private IconButton AddButton(Texture icon, string tooltip, string ussClassName, Action action, bool beginning)
		{
