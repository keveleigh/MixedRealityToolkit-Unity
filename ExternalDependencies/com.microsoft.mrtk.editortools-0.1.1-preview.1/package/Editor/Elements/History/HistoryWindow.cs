...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	public class HistoryWindow : EditorWindow
	{
		...
		public const string UssClassName = "uxtools-history";
		...
		private const string _windowMenu = "UX Tools/History/Open";
		private const string _moveBackMenu = "UX Tools/History/Move Back &LEFT";
		private const string _moveForwardMenu = "UX Tools/History/Move Forward &RIGHT";
