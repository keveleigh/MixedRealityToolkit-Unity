...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidTypeWarning = "Invalid type for MinimumAttribute on field {0}: Minimum can only be applied to int or float fields";
		private const string _invalidSourceError = "Invalid source for MinimumAttribute on field '{0}': a field, method, or property of type '{1}' named '{2}' could not be found";
