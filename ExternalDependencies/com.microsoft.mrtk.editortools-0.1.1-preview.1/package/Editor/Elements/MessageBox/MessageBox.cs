...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public class MessageBox : VisualElement
	{
		...
		private const string _invalidTypeWarning = "Invalid message type '{0}' for MessageBox: message-type must be one of 'Info', 'Warning', or 'Error'";
		...
		public const string UssClassName = "uxtools-message-box";
