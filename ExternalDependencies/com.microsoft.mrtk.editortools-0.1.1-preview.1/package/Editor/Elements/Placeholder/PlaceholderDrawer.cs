...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidDrawerWarning = "Invalid drawer for PlaceholderAttribute on field '{0}': Placeholder can only be applied to fields with TextField drawers";
		private const string _invalidSourceError = "Invalid value source for PlaceholderAttribute on field '{0}': a string field, method, or property named '{1}' could not be found";
