...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidDrawerWarning = "Invalid drawer for MaximumLengthAttribute on field {0}: MaximumLength can only be applied to fields with a TextField";
		private const string _invalidSourceError = "Invalid source for MaximumLengthAttribute on field '{0}': an int field, method, or property named '{1}' could not be found";
