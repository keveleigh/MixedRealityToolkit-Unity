...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	class ValidateDrawer : PropertyDrawer
	{
		...
		public const string UssClassName = "uxtools-validate";
		...
		private const string _invalidTypeWarning = "Invalid type for ValidateAttribute on field '{0}': Validate can only be applied to serializable fields";
		private const string _invalidMethodWarning = "Invalid method for ValidateAttribute on field '{0}': the method '{1}' should return a bool and take 0, or 1 parameter of type '{2}'";
