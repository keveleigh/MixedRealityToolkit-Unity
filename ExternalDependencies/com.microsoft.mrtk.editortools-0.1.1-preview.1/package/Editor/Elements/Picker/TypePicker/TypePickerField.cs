...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public class TypePickerField : PickerField<string>
	{
		...
		public new const string UssClassName = "uxtools-scene-picker-field";

		#endregion

		#region Log Messages

		private const string _invalidTypeWarning = "Invalid type for TypePickerField: the type '{0}' could not be found";
		private const string _invalidValueWarning = "Failed to set TypePickerField value: '{0}' is not derivable from type '{1}'";
