...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public class EnumButtonsField : BaseField<Enum>
	{
		...
		public const string UssClassName = "uxtools-enum-buttons-field";
		...
		private const string _invalidTypeWarning = "Failed to setup EnumButtonsField: the type '{0}' is not an enum";
		private const string _invalidValueWarning = "Failed to set EnumButtonsField value: '{0}' is not a valid value for the enum '{1}'";
