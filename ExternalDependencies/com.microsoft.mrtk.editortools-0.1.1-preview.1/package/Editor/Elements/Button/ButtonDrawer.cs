...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	class ButtonDrawer : PropertyDrawer
	{
		...
		public const string UssClassName = "uxtools-trait-button";
		...
		private const string _invalidMethodWarning = "Invalid method for ButtonAttribute on field '{0}': a parameterless method named '{1}' could not be found on type '{2}'";
