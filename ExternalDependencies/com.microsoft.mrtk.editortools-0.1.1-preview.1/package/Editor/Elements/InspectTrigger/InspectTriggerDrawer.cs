...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	...
	{
		private const string _invalidMethodWarning = "Invalid method for InspectTriggerAttribute on field '{0}': a parameterless method named '{1}' colud not be found on type '{2}'";
