...
namespace Microsoft.MixedReality.Toolkit.EditorTools
{
	public class Icon
	{
		...
		public static readonly Icon Reset = BuiltIn("Refresh");
		...
		public static readonly Icon Search = BuiltIn("Search Icon");
		...
		private const string _invalidIconError = "Failed to create icon texture: the built in icon {0} could not be loaded";
		private const string _invalidDataError = "Failed to create icon texture: the supplied data is not a valid base 64 string";
		private const string _invalidTextureError = "Failed to create icon texture: the supplied data is not a valid texture";
